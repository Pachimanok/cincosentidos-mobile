...
<head>
    ...
    <!-- Nucleo Icons -->
    <link href="{{ asset('assetsDash/css/nucleo-icons.css')}}" rel="stylesheet" />
    <link href="{{ asset('assetsDash/css/nucleo-svg.css')}} rel="stylesheet" />
    <!-- Font Awesome Icons -->
    <script src="https://kit.fontawesome.com/42d5adcbca.js" crossorigin="anonymous"></script>
    <link href="{{ asset('assetsDash/css/nucleo-svg.css')}}" rel="stylesheet" />
    <!-- CSS Files -->
    <link id="pagestyle" href="{{ asset('assetsDash/css/soft-ui-dashboard.css?v=1.0.3')}}" rel="stylesheet" />
